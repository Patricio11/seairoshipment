    ...
    return (
        <div className="space-y-6">
            ...
            <CreateLocationDialog
                ...
                open={editDialogOpen}
                onOpenChange={(open) => { setEditDialogOpen(open); if (!open) setEditingLocation(null) }}
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between mt-6 pt-4 border-t border-slate-800">
                                    ...
                                    <div className="flex gap-2">
                                        <Button size="icon" variant="ghost" className="h-8 w-8 text-slate-400 hover:text-blue-400" onClick={() => handleEdit(loc)}>
                                            <Edit className="h-4 w-4" />
                                        </Button>
                                        <Button size="icon" variant="ghost" className="h-8 w-8 text-slate-400 hover:text-red-400" onClick={() => handleDelete(loc)}>
