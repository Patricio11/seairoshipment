                    ...
                    <div className="flex h-20 items-center justify-between">
                        ...
                        <div className="hidden items-center gap-4 md:flex">
                            ...
                            <button
                                ...
                                className="rounded-xl bg-brand-blue px-6 py-3 text-sm font-bold text-white shadow-lg shadow-brand-blue/30 transition-all hover:bg-brand-blue/90 hover:shadow-brand-blue/50"
                            >
                                Get Started
                            </button>
                        </div>
                            ...
                            <div className="space-y-1 px-6 py-4">
                                ...
                                <div className="pt-4 space-y-2">
                                    ...
                                    <button
                                        ...
                                        className="block w-full rounded-xl bg-brand-blue px-4 py-3 text-center text-sm font-bold text-white"
                                    >
                                        Get Started
                                    </button>
                                </div>
