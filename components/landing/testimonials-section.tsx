                        ...
                        >
                            <div className="relative rounded-2xl border-2 border-slate-200 bg-white p-12 shadow-xl">
                                ...
                                <div className="absolute -top-6 left-12">
                                    <div className="rounded-xl bg-brand-blue p-4 shadow-lg">
                                ...
                                <div className="mt-8 flex items-center gap-4">
                                    <div className="flex h-16 w-16 items-center justify-center rounded-full bg-brand-blue text-3xl shadow-lg">
