...
async function seed() {
    ...
    await db
        ...
        .values([
            { id: "of-1", salesRateTypeId: "srs", origin: "Cape Town/ Durban", destinationCountry: "UK", destinationPort: "London Gateway", destinationPortCode: "GBLON", shippingLine: "MSC", containerId: "40ft-reefer-hc", effectiveFrom: "2024-01-01", effectiveTo: "2024-12-31", freightUSD: "4606.00", bafUSD: "882.00", ispsUSD: "15.00", otherSurchargesUSD: "55.00", rcgUSD: "42.00", totalUSD: "5600.00", exchangeRate: "15.9", totalZAR: "89040.00", active: true },
    ...
    await db
        ...
        .values([
            { id: "dc-lon-40hc-srs", salesRateTypeId: "srs", destinationId: "lon", destinationName: "London Gateway", destinationPortCode: "GBLON", containerId: "40ft-reefer-hc", currency: "GBP", exchangeRateToZAR: "22.30", effectiveFrom: "2024-01-01", effectiveTo: "2024-12-31", active: true },
